<?php 
	...
	$book_mark = Jy_helper::bookmar_result($current_user->ID);
					...
					<div class="dashboard-container">
						<div class="dashboard-content-wrapper">
							<div class="dashboard-bookmarked">
								<h4 class="bookmark-title"><span id="total_job"><?php print count($book_mark); ?></span> <?php esc_html_e("Job Bookmarked","jemployee"); ?></h4>
								<div class="bookmark-area">
									<?php 
										$k = array_keys($book_mark);
										$k = !empty($k)?$k:array(0);
										$args = array(
											'post_type' => 'jy_job',
											'post_status' => 'publish',
									...
									?>
									<div class="job-list" id="job_list_<?php  esc_attr_e($j_id); ?>">
										<div class="thumb">
											<a href="#">
										...
										<div class="body">
											...
											<div class="more">
												<a href="#" data-job_id="<?php esc_attr_e($j_id); ?>" class="bookmark-remove"><i class="fas fa-times"></i></a>
